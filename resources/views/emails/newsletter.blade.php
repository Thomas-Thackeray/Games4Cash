...
<head>
    ...
    <style>
        ...
        .body { padding: 40px; }
        .content { font-size: 1rem; color: #555577; line-height: 1.75; margin: 0 0 28px; white-space: pre-line; }
        ...
        .unsub { font-size: 0.78rem; color: #aaaabc; text-align: center; margin-top: 8px; }
        .unsub a { color: #aaaabc; }
    </style>
</head>
<body>
<div class="wrapper">
    <div class="card">
        ...
        <div class="body">
            ...
            <div class="cta-wrap">
                <a href="{{ url('/') }}" class="cta-btn">Browse Games</a>
            </div>

            <hr class="divider">

            <p style="font-size:0.85rem; color:#888899; text-align:center; margin:0;">
                Need help? <a href="{{ url('/contact') }}" style="color:#e63946;">Contact us</a>.
            </p>
        </div>
