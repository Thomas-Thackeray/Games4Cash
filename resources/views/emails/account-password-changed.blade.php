...
<div class="wrapper">
    <div class="card">
        ...
        <div class="body">
            ...
            <p class="intro">We're letting you know that the password on your {{ config('app.name') }} account was recently changed.</p>
            ...
            <div class="alert-box">
                <p><strong>Wasn't you?</strong> If you did not change your password, please contact us immediately so we can secure your account.</p>
            </div>
            ...
            <p class="body-note">If you changed your password yourself, no further action is needed. We recommend using a unique, strong password that you don't use elsewhere.</p>
        </div>
