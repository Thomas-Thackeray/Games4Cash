...
@section('content')
<div class="container" style="max-width:680px; padding-top:2.5rem; padding-bottom:3rem;">
    ...
    <section class="account-card">
        ...
        <form method="POST" action="{{ route('evaluations.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-top:1rem;">
                <label>Photos <span style="font-weight:400; color:var(--text-muted);">(up to 5 images, max 5 MB each)</span></label>
